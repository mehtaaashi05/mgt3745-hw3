...
Root [CLAUDE.md](../CLAUDE.md) imports this file for Claude Code. VS Code Copilot uses the separate [.github/copilot-instructions.md](../.github/copilot-instructions.md) adapter. A location under `/context` alone is not a guarantee of automatic loading for every tool.
